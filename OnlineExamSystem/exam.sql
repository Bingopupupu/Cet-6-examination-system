...
) ENGINE=InnoDB AUTO_INCREMENT=2023002 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin ROW_FORMAT=DYNAMIC COMMENT='管理员信息表';

/*Data for the table `admin` */

insert  into `admin`(`adminId`,`adminName`,`sex`,`tel`,`email`,`pwd`,`cardId`,`role`) values (2023001,'超级管理员','男','13658377857','1253838283@qq.com','123456','3132','0');
...
) ENGINE=InnoDB AUTO_INCREMENT=20190015 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin ROW_FORMAT=DYNAMIC COMMENT='考试管理表';

/*Data for the table `exam_manage` */

insert  into `exam_manage`(`examCode`,`description`,`source`,`paperId`,`examDate`,`totalTime`,`grade`,`term`,`major`,`institute`,`totalScore`,`type`,`tips`) values (20190001,'2022年春cet6考试','2022年春cet6考试',1001,'2022-03-21',180,'2020','1','所有专业','外国语学院',710,'语言考试','请同学们提前15min到场，携带身份证'),(20190002,'2022年秋cet6考试','2022年秋cet6考试',1001,'2022-09-21',180,'2020','1','所有专业','外国语学院',710,'语言考试','请同学们提前15min到场，携带身份证'),(20190003,'2023年春cet6考试','2023年春cet6考试',1001,'2023-03-21',180,'2020','1','所有专业','外国语学院',710,'语言考试','请同学们提前15min到场，携带身份证');
...
insert  into `paper_manage`(`paperId`,`questionType`,`questionId`) values (1001,1,10013),(1001,1,10005),(1001,1,10001),(1001,1,10004),(1001,1,10000),(1001,1,10016),(1001,1,10032),(1001,1,10025),(1001,1,10030),(1001,1,10017),(1001,1,10027),(1001,1,10023),(1001,1,10014),(1001,1,10009),(1001,1,10008),(1001,1,10011),(1001,1,10010),(1001,1,10021),(1001,1,10022),(1001,1,10026),(1001,2,10017),(1001,2,10012),(1001,2,10004),(1001,2,10005),(1001,2,10003),(1001,2,10008),(1001,2,10020),(1001,2,10013),(1001,2,10006),(1001,2,10015),(1001,3,10002),(1001,3,10009),(1001,3,10003),(1001,3,10005),(1001,3,10004),(1001,3,10012),(1001,3,10011),(1001,3,10006),(1001,3,10008),(1001,3,10001),(1010,1,10033);
...
) ENGINE=InnoDB AUTO_INCREMENT=20235010 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin ROW_FORMAT=DYNAMIC COMMENT='学生信息表';

/*Data for the table `student` */

insert  into `student`(`studentId`,`studentName`,`grade`,`major`,`clazz`,`institute`,`tel`,`email`,`pwd`,`cardId`,`sex`,`role`) values (20234001,'隔壁老王','2015','计算机科学与技术','2','软件工程学院','13585439532','gblw@163.com','123456','3412312','男','2'),(20234084,'大咸鱼','2015','计算机科学与技术','2','软件工程学院','13658377857','13658377857@sina.cn','123456','124123124535','男','2'),(20235003,'张大宝','2015','信息工程','1','软件工程学院','15583829425','15583829425@163.com','123456','3242342','男','2'),(20235007,'翠花','2015','网络工程','1','软件工程学院','18734538457','18734538457@163.com','123456','2423423','女','2'),(20235008,'小王','2015','信息工程','2','软件工程学院','15523619564','15523619564@163.com','123456','500234199704022353','男','2'),(20235009,'刘大大','2','计算机','2','计算机','1','1','123456','2','男','2');
...
) ENGINE=InnoDB AUTO_INCREMENT=20231003 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin ROW_FORMAT=DYNAMIC COMMENT='教师信息表';

/*Data for the table `teacher` */

insert  into `teacher`(`teacherId`,`teacherName`,`institute`,`sex`,`tel`,`email`,`pwd`,`cardId`,`type`,`role`) values (20231001,'张老师','软件工程学院','男','13598458442','13598458442@163.com','123456','423423283498','讲师','1'),(20231002,'王大志','软件工程学院','男','1231221312','1231221312@163.com','123456','24241234','讲师','1');
