  ...
  <div id="login">
    ...
    <el-row class="main-container">
      <el-col :lg="8" :xs="16" :md="10" :span="10">
        <div class="top">
          <i class="iconfont icon-kaoshi"></i><span class="title">英语六级在线考试系统</span>
        </div>
        <div class="bottom">
          <div class="container">
    ...
    <el-row class="footer">
      <el-col>
        <p class="msg2">版权所有 ©2023  保留所有权利  <a href="http://beian.miit.gov.cn/" target="_blank">xxxxxx号</a></p>
      </el-col>
    </el-row>
    <section class="remind">
      <span>管理员示例账号：2023001</span>
      <span>教师示例账号：20231001</span>
      <span>学生示例账号：20235008</span>
